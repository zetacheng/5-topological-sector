...
Source branch/ref: `legacy-kappa/main` with exact/PV work also verified at `legacy-kappa/claude/c2a-kappa-u-skyrme-35v1ap`.

| Original path | Destination path under `results/c2a/` | Source commit | Transfer | Transformation script |
|---|---|---|---|---|
| `derive_classes_output.txt` | `derive_classes_output.txt` | `168d890334e67a4bbfca4dea5b84e8036a44acfa` | Copied byte-for-byte | None |
| `p4_gate_output.txt` | `p4_gate_output.txt` | `2f9758dcf105c10dcd53a420d95ef4f9bd505765` | Copied byte-for-byte | None |
| `results/scan_data.csv` | `scan_data.csv` | `6210279f22693da6f7f4406509203ad8d495aa88` | Copied byte-for-byte | None |
